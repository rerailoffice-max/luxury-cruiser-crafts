# ヨットカタログ 画像配置マップ & AI生成プロンプト集

> **プレゼンテーション**: 伝統工芸 × クルーザー カタログ
> **作成日**: 2026-02-25（更新: 2026-02-25）
> **推奨ツール**: Midjourney v7
> **画像サイズ**: 16:9（スライド用）
> **方針**: 各クルーザーの実際のサイズ・内装特徴に合わせ、日本の伝統工芸を上品に取り入れた高級内装。撮影スタイルは「ultra high-end interior design photography」。
...
| モデル | サイズ | 特徴 | 価格 |
|--------|--------|------|------|
| Lexus LY680 | 68ft (20.7m) | ダークバニッシュドウッド内装、3キャビン | ¥7億7000万 |
| Lexus LY650 | 65ft (19.8m) | ホワイト基調、3ステートルーム | ¥4億5000万 |
| Yamaha PRESTIGE M48 | 48ft (14.79m) | 日本最高峰フラッグシップ | ¥2億 |
| Yamaha PRESTIGE F4.9 | 49ft (14.9m) | 2024年新型、モダンデザイン | ¥3億 |
...
| カテゴリ | 枚数 | 調達方法 |
|---------|------|---------|
| A. AI生成（ヨット内装 × 伝統工芸） | **11枚** | Midjourney v7 |
| B. 写真素材（伝統工芸・職人） | **10枚** | ストックフォト or 工房提供 |
| C. 写真素材（ヨット外観） | **1枚** | メーカーサイト / プレス素材 |
| D. コラージュ・グリッド | **2枚** | 素材合成（Canva等） |
| E. クライアント提供 | **1枚** | 代表者写真 |
| **合計** | **25枚** | — |
...
- 各船の**実際のサイズ（ft）と内装特徴**を明記してスケール感を正確に
- 工芸品は**2〜3点を上品に配置**（天井・壁・テーブルなど）
- ベースは実際のクルーザー内装（レザー・チーク材・マリン仕様）
- 窓の外に海が見える構図
- 撮影スタイル: `ultra high-end interior design photography, soft natural light, 8K`
- Midjourney: `--ar 16:9 --v 7`

---

## A. AI生成画像（11枚）— ヨット内装 × 伝統工芸

---

### A-01: S05 — トレンド紹介（組子天井＋金箔アクセント）
- **スライド**: S05 Trends × Crafts（右側）
- **要素ID**: `shape_6a9aac7a`
...
### A-02: S21 — CONCEPT 01「金と漆の煌めき」
- **スライド**: S21 Gold & Lacquer Brilliance（右側）
- **要素ID**: `shape_2ea17051`
...
### A-03: S22 — CONCEPT 02「禅 — 静寂の調和」
- **スライド**: S22 ZEN Minimalist Harmony（右側）
- **要素ID**: `shape_67ed0151`
...
### A-04: S23 — CONCEPT 03「海と光」
- **スライド**: S23 Sea & Light（右側）
- **要素ID**: `shape_e11a5ad3`
...
### A-05: S24 — CONCEPT 04「伝統と革新」
- **スライド**: S24 Heritage Innovation（右側）
- **要素ID**: `shape_bb216257`
...
### A-08: S28 — Yamaha PRESTIGE M48 個別ページ
- **スライド**: S28（右側）
- **要素ID**: `shape_2c950165`
...
### A-09: S29 — Yamaha PRESTIGE F4.9 個別ページ
- **スライド**: S29（右側）
- **要素ID**: `shape_274c21e5`
...
### A-10: S30 — Toyota Ponam-35 個別ページ
- **スライド**: S30（右側）
- **要素ID**: `shape_01d38924`
...
### A-11: S31 — Toyota Ponam-31 個別ページ
- **スライド**: S31（右側）
- **要素ID**: `shape_9520edb8`
...
### B-01: S02 — 金沢箔パネル クローズアップ
- **スライド**: S02 Concept Statement（左側）
- **要素ID**: `shape_811de673`
...
| # | 要素ID | 内容 | 検索キーワード |
|---|--------|------|---------------|
| B-06 | `shape_d7494768` | 金箔職人の手元（箔を竹箸で持ち上げる瞬間） | 「金箔職人 竹箸」「kinpaku artisan」 |
| B-07 | `shape_61fe35f0` | 蒔絵職人が金粉を蒔く瞬間 | 「蒔絵 金粉」「maki-e gold powder」 |
...
### C-01: S01 — カバー背景（任意）
- **スライド**: S01 Cover
- **内容**: 背景に海上のクルーザー写真を配置すると効果的
- **候補**:
  - Lexus LY680 の公式プレスフォト（海上走行シーン）
  - 夕暮れの海にたたずむヨットのシルエット
...
### D-01: S12 — 4分割フォトグリッド（CRAFTS扉）
- **スライド**: S12 CRAFTS opener
- **要素ID**: `shape_ac6f9442`
...
|---------|------|
| S03 INDEX | 目次テキストのみ |
| S06 Superyacht Cases | テキストカード3枚 |
| S09 Service Flow | 6ステップテキスト |
| S10 Pricing | 料金カード3枚 |
| S13-S18 工芸カタログ | テキストカード（工芸品写真は任意追加可） |
| S32 Partners | 工房名リストのみ |
...
### 最優先（プレゼンの核心）
1. **A-02** CONCEPT 01 金と漆（S21）— LY680 ¥7.7億
2. **A-03** CONCEPT 02 禅（S22）— LY650 ¥4.5億
3. **A-04** CONCEPT 03 海と光（S23）— PRESTIGE M48 ¥2億
4. **A-05** CONCEPT 04 伝統と革新（S24）— F4.9 ¥3億

### 高優先（ヨットモデル個別ページ）
5. **A-06** LY680 内装（S26）— ¥7.7億
6. **A-07** LY650 内装（S27）— ¥4.5億
7. **A-08** PRESTIGE M48 内装（S28）— ¥2億
8. **A-09** PRESTIGE F4.9 内装（S29）— ¥3億

### 中優先
9. **A-01** トレンド紹介用（S05）
10. **A-10** Ponam-35 キャビン（S30）— ¥4,500万+
11. **A-11** Ponam-31 キャビン（S31）— ¥3,500万+
12. **B-01〜B-09** 工芸・職人写真
13. **D-01, D-02** コラージュ

### 最後（任意）
14. **C-01** カバー背景
15. **E-01** 代表者写真（クライアント提供待ち）
...
- **バージョン**: `--v 7`
- **アスペクト比**: `--ar 16:9`
- **トーン**: 上品で高級感のある内装写真。工芸品は2〜3点を品よく配置
- **共通サフィックス**: `ultra high-end interior design photography, soft natural light, 8K --ar 16:9 --v 7`
- **各船の個性**:
  - LY680: ダークバニッシュドウッド × 金箔＋漆＋蒔絵＋西陣織
  - LY650: ホワイト基調 × 和紙＋組子＋有田焼
  - PRESTIGE M48: 日本フラッグシップ × 切子＋薩摩切子＋七宝
  - F4.9: モダンデザイン × 西陣織＋金箔＋LED
  - Ponam-35: コンパクト × 漆＋組子
  - Ponam-31: スポーティ × 切子＋西陣織
